...
namespace EEaseWebAPI.Application.Abstractions.Services
{
    public interface IRouteService
    {
        ...
        Task<(List<StandardRouteDTO> Routes, int TotalCount)> GetAllRoutes(string username, int pageNumber = 1, int pageSize = 10, CancellationToken cancellationToken = default);

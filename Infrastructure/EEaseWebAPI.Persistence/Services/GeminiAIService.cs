...
All preferences are scored on a scale of 0-100 where:
- 0 means 'strongly dislike' or 'never prefer'
- 25 means 'somewhat dislike' or 'rarely prefer'
- 50 means 'neutral' or 'sometimes prefer'
- 75 means 'somewhat like' or 'often prefer'
- 100 means 'strongly like' or 'always prefer'
